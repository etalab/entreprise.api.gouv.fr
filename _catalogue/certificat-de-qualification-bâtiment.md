...
description: Obtenir le certificat Qualibat, apportant l’avis de l’association
  ...
  d'autres certificats de qualification, l'endpoint certification RGE regroupe
  tous les certificats, dont les Qualibats.
usecases:
  - Marchés publics
  ...
  service1:
    request:
      ...
      questions:
        qr1:
          answer: >-
            * Qualifications « Mesurage dans le bâtiment » ;
        ...
        qr2:
          answer: >-
            ...
            reconnaissance des compétences de l’entreprise, de sa capacité à
            réaliser des travaux dans une activité donnée, à un niveau de
            technicité défini. Elles donnent à l’entreprise les moyens de
            faire-valoir son expertise technique et permettent au maître
            d’ouvrage d’identifier précisément les professionnels capables de
            répondre à sa demande. Les certifications métiers caractérisent les
            entreprises aptes à répondre à certaines activités nécessitant le
            respect de réglementations particulières en matière d’environnement,
            de sécurité ou de protection de la santé. Elles sont attribuées à
            partir de référentiels techniques spécifiques. En plus de la
            reconnaissance du savoir-faire, elles supposent la mise en place
            d’un système d’organisation et de procédures au sein de
            l’entreprise. 
