...
La liste exhaustives des données et des documents et les modalités techniques de consultation sont précisés dans la [documentation technique](https://doc.entreprise.api.gouv.fr).
...
- [De la loi n° 78-17 du 6 janvier 1978](https://www.legifrance.gouv.fr/affichTexte.do?cidTexte=JORFTEXT000000886460) modifiée relative à l'informatique, aux fichiers et aux libertés,
...
- Le jeton est émis pour une durée maximum de deux ans, sauf révocation. Deux mois avant l'échéance, le Partenaire est invité à reformuler une demande d'adhésion au service s'il le souhaite.
...
- Lorsqu'il souhaite surveiller la disponibilité de l'API entreprise, le Partenaire s'engage à utiliser le mécanisme de surveillance prévu à cet effet et disponible sur la partie privée du site : https://dashboard.entreprise.api.gouv.fr/  
...
- Le partenaire s'engage à mettre à jour les coordonnées des responsables technique et fonctionel afin de pouvoir être contacté par la DINSIC. Ces informations sont modifiables à l'adresse suivante : https://dashboard.entreprise.api.gouv.fr/. 

## 4. Rôle et engagement de la DINSIC

- La DINSIC met en œuvre et opère le Service conformément aux dispositions légales et réglementaires en vigueur. A ce titre, la DINSIC s’engage à respecter les obligations légales liées au traitement, notamment celles relevant de la loi n° 78-17 du 6 janvier 1978 relative à l’informatique aux fichiers et aux libertés.

- La DINSIC s’engage à transmettre les données demandées par le Partenaire via le Service au regard de son droit d'en connaître.

- La DINISC met à disposition le site internet https://dashboard.entreprise.api.gouv.fr afin de permettre au Partenaire de : 
    -  récupérer le jeton d'accès (sous reserve de l'acceptation de la demande d'adhésion et des données afférentes)
    -  consulter les statistiques d'usage des données,
    -  de visualiser les dernières requêtes effectuées,
    -  mettre à jour les coordonnées des contact.
...
- Toute modification des présentes CGU par la DINSIC fera l’objet d’une information aux Partenaires.
