...
{:.tpl-notification}
Si vous souhaitez mettre en œuvre des aides ou subventions relatives ou non au covid-19, indépendantes de cette aide, merci de consulter la page dédiée ["aides et subventions"]({% link _use_cases/aides_publiques.md %}).
...
Pour votre demande d'accès, veuillez consulter la page ["Demander un accès"]({% link pages/demander_un_acces.md %}), un déroulé des étapes vous sera décrit.
